...
HEIGHT = 500
background = white
player = pygame.transform.scale(pygame.image.load('doodle.jpg'), (90, 70))
fps = 60
...
while running:
    ...
    if x_change > 0:
        ...
        player = pygame.transform.flip(pygame.transform.scale(pygame.image.load('doodle.jpg'), (90, 70)), 1, 0)
